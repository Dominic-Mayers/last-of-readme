...
} = require('./remind-not-owned-hooks.cjs');
const {
  installDocLinkFile,
} = require('./install-doc-link-file.cjs');
const {
  installRemoteConfig,
} = require('./install-remote-config.cjs');
const {
  installDocLinkConfig,
} = require('./install-doc-link-config.cjs');
const {
  installNonInteractivePolicy,
} = require('./install-non-interactive-policy.cjs');
const {
