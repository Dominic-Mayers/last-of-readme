...
## The files of Last of Readme:
    ...
    |-- move-prompts-to-adapter-zone.patch
    |-- nbproject
    |   |-- private
    |   |   |-- private.properties
    |   |   `-- private.xml
...
> Another way to view the importance of this architectural rule is to consider a different environment with a different language, say French instead of English.
